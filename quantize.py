...
from torch.ao.quantization.observer import MinMaxObserver,HistogramObserver,default_per_channel_weight_observer
...
if __name__ == "__main__":
    ...
    # model_qconfig = QConfig(activation=MinMaxObserver.with_args(reduce_range=False),
    ...
    # model_fp32_prepared.quant.activation_post_process.min_val = torch.tensor(-2.1179)
