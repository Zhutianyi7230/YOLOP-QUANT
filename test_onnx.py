...
def build_onnxsession(weight="yolop-640-640.onnx"):
...
def infer_yolop(ort_session,img_path="./inference/images/7dd9ef45-f197db95.jpg"):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight', type=str, default="yolop-640-640-quant.onnx")
    parser.add_argument('--img', type=str, default="./inference/images/000001.png")
    args = parser.parse_args()

    ort_session = build_onnxsession(weight=args.weight)
    infer_yolop(ort_session,img_path=args.img)
    """
