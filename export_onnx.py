...
if __name__ == "__main__":
    ...
    # # model_fp32.load_state_dict(torch.load('./model_float32.pth'))
    # model_fp32.eval()
    ...
    onnx_path = f'./yolop-{height}-{width}.onnx'
    ...
    x = inputs.cpu().numpy()
    try:
        sess = ort.InferenceSession(onnx_path,providers=ort.get_available_providers())#这一行会报错，很可能是onnxruntime版本问题
